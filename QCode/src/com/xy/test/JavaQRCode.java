...
public class JavaQRCode {
     ...
     * @param size 二维码尺寸 
     */ 
	public void encoderQRCode(String content,String imagePath,String imgType,int size){
		try {
			//生成图片
			BufferedImage bufImg = qRCodeCommon(content, imgType,size);
			// 生成二维码QRCode图片  
            ImageIO.write(bufImg, imgType, new FileOutputStream(imagePath));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
    ...
    public static BufferedImage qRCodeCommon(String content, String imgType, int size) {  
    	...
    	try {
         ...
         // 设置背景颜色  WHITE白色
            ...
            Image img = ImageIO.read(new File("E:/2.jpg"));//实例化一个Image对象
            int iWidth=imgSize/4;
    ...
    public static void main(String[] args) {  
        String imgPath = "e:/二维码.png";  
        StringBuffer s =new StringBuffer();
        s.append("姓名:高成德"+"\n");
        s.append("性别:男"+"\n");
        s.append("年龄:28");
        String encoderContent=s.toString();
