...
import com.xy.test.TwoDimensionCodeImage;
	...
	public static void createQRcode(String path,Integer size,String content){
	 ...
	 /**
	    ...
	    /**
	         ...
	         * 生成一个二维码返回一个BufferedImage的图片流  中间有logo
	         ...
	         * @param logostream 中间的logo的流
	    
	         */
	    
	        public static BufferedImage createQRcode(Integer size,String content,InputStream logostream){
	        ...
	        /**
	            ...
	            public static String decodeQRcode(String imgpath){
	                ...
	                try {  
	                    ...
	                    QRCodeDecoder decoder = new QRCodeDecoder(); //解析对象 
